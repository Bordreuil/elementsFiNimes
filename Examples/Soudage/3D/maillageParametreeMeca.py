...
Local_Length_2          = Regular_1D_5.LocalLength(localength,None,1e-07)
...
Number_of_Segments_4    = Regular_1D_6.NumberOfSegments(nseg)
Regular_1D_7            = Maillage_2.Segment(geom=extru)
Local_Length_3          = Regular_1D_7.LocalLength(localength,None,1e-07)
Regular_1D_8            = Maillage_2.Segment(geom=ctr_1)
Number_of_Segments_5    = Regular_1D_8.NumberOfSegments(nseg)
...
Start_and_End_Length_1  = Regular_1D_10.StartEndLength(localength,endlength,[])
