...
coords =array([[0.,0.],                      
               ...
               [0.,L_barre],
               [L_barre,L_barre],      
               [L_barre+L_barre*sqrt(3.)/2.,L_barre/2.],
               [-L_barre*sqrt(3.)/2.,L_barre/2.],
               [L_barre/2.,L_barre+L_barre*sqrt(3.)/2.]]   ,'d') 
...
el6 = barre2D([2,3],L_barre,E,S,0.*pi/180.)
el7 = barre2D([3,4],L_barre,E,S,-30.*pi/180.)
