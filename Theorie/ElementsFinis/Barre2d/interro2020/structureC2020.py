...
coords =array([[0.,0.],                       
               [0.,L_barre],
               [0.,2.*L_barre],
               [s3s2*L_barre,L_barre/2.],
               [s3s2*L_barre,3.*L_barre/2.],        
               [s3s2*L_barre+L_barre,L_barre/2.],      
               [s3s2*L_barre+L_barre,3*L_barre/2.],
               [2.*s3s2*L_barre+L_barre,L_barre]]   ,'d') 

Du  = zeros(coords.shape,'d')


el1 = barre2D([0,1],L_barre,E,S,90.*pi/180.)
el2 = barre2D([1,2],L_barre,E,S,90.*pi/180.)
el3 = barre2D([0,3],L_barre,E,S,30.*pi/180.)
el4 = barre2D([3,1],L_barre,E,S,150.*pi/180.)
el5 = barre2D([1,4],L_barre,E,S,30.*pi/180.)
el6 = barre2D([2,4],L_barre,E,S,-30.*pi/180.)
el7 = barre2D([3,4],L_barre,E,S,90.*pi/180.)
el8 = barre2D([3,5],L_barre,E,S,0.)
el9 = barre2D([3,6],sqrt(2.)*L_barre,E,S,45.*pi/180.)
el10 = barre2D([4,6],L_barre,E,S,0.*pi/180.)
el11 = barre2D([5,6],L_barre,E,S,90.*pi/180.)
el12 = barre2D([5,7],L_barre,E,S,30.*pi/180.)
el13 = barre2D([6,7],L_barre,E,S,-30.*pi/180.)
