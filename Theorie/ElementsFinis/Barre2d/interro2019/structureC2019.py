...
el2 = barre2D([2,3],L_barre,E,S,0.*pi/180.)
el3 = barre2D([0,4],sqrt(2.)*L_barre,E,S,45.*pi/180.)
el4 = barre2D([1,4],L_barre,E,S,90.*pi/180.)
el5 = barre2D([1,5],sqrt(2.)*L_barre,E,S,45.*pi/180.)
el6 = barre2D([5,6],L_barre,E,S,0.*pi/180.)
el7 = barre2D([2,6],L_barre,E,S,0.*pi/180.)
el8 = barre2D([3,6],sqrt(2.)*L_barre,E,S,135*pi/180.)
el9 = barre2D([4,5],L_barre,E,S,0.*pi/180.)
el10 = barre2D([4,7],sqrt(2.)*L_barre,E,S,45.*pi/180.)
el11 = barre2D([5,7],L_barre,E,S,90.*pi/180.)
el12 = barre2D([2,5],L_barre,E,S,135.*pi/180.)
el13 = barre2D([5,6],L_barre,E,S,0.*pi/180.)
el14 = barre2D([6,7],sqrt(2.)*L_barre,E,S,135.*pi/180.)

els=[el1,el2,el3,el4,el5,el6,el7,el8,el9,el10,el11,el12,el13,el14]

plotElements(coords,els)
axis([-100,4.*L_barre+100,-100.,4.*L_barre+100.])
